...
B --> C[Engenharia de Prompts]

C --> D[Validação das Respostas]

D --> E[Miniguia de Estudo]
...
B -->|Não| C[Permanece CLT]

B -->|Sim| D[Planejamento Financeiro]

D --> E[Reserva de Emergência]

E --> F[Escolha do Regime]

F --> G[MEI]

F --> H[PJ]

G --> I[Abertura da Empresa]

H --> I

I --> J[Negociação Contratual]

J --> K[Início das Atividades]
```
